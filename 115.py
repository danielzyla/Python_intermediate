...
birthday=SpecialCake('Cake', 'Muffin', 'Lemon', ['chocolate', 'soft sugar'], 'cream', 'birthday', 'standard', 'stars', 'Happy birthday')
birthday.show_info()

birthday=SpecialCake('Cake', 'Wedding-cake', 'Vanila', ['chocolate', 'jelly'], 'strawberries', 'wedding', 'piramid', 'hearts', 'Happy life')
birthday.show_info()
